...
// ######################
    private static class AddRecipeAction extends OneWayAction {
        ...
        public AddRecipeAction(IItemStack output1, IItemStack output2, ILiquidStack fluidOutput, ILiquidStack fluidInput, IItemStack input1, IItemStack input2, int duration, int euPerTick, int heat) {
