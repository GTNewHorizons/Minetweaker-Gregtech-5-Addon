...
// ######################
    ...
    private static class AddRecipeAction extends OneWayAction {
        ...
        public int hashCode() {
            int hash = 6;
            hash = 77 * hash + (this.output1 != null ? this.output1.hashCode() : 0);
            hash = 77 * hash + (this.output2 != null ? this.output2.hashCode() : 0);
            hash = 77 * hash + (this.output3 != null ? this.output3.hashCode() : 0);
            hash = 77 * hash + (this.output4 != null ? this.output4.hashCode() : 0);
            hash = 77 * hash + (this.output5 != null ? this.output5.hashCode() : 0);
            hash = 77 * hash + (this.output6 != null ? this.output6.hashCode() : 0);
            hash = 77 * hash + (this.fluidOutput != null ? this.fluidOutput.hashCode() : 0);
            hash = 77 * hash + (this.input != null ? this.input.hashCode() : 0);
            hash = 77 * hash + (this.cells != null ? this.cells.hashCode() : 0);
            hash = 77 * hash + (this.fluidInput != null ? this.fluidInput.hashCode() : 0);
