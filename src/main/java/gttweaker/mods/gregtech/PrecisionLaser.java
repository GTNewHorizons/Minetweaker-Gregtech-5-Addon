...
// ######################
    private static class AddRecipeAction extends OneWayAction {
        ...
        @Override
        public String describe() {return "Adding Precision Laser recipe for " + output;}
        @Override
        public Object getOverrideKey() {return null;}
        @Override
        public int hashCode() {
            int hash = 4;
            hash = 45 * hash + (this.output != null ? this.output.hashCode() : 0);
            hash = 45 * hash + (this.input1 != null ? this.input1.hashCode() : 0);
            hash = 45 * hash + (this.input2 != null ? this.input2.hashCode() : 0);
            hash = 45 * hash + this.duration;
            hash = 45 * hash + this.euPerTick;
            return hash;
        }
        @Override
