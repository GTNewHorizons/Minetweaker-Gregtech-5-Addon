...
public class Slicer {
     ...
     */
    @ZenMethod
    public static void addRecipe(IIngredient output, IIngredient input, IIngredient blade, int durationTicks, int euPerTick) {
...
// ######################
    private static class AddRecipeAction extends OneWayAction {
        ...
        private final IIngredient blade;
        private final int duration;
        private final int euPerTick;
        public AddRecipeAction(IIngredient output, IIngredient input, IIngredient blade, int duration, int euPerTick) {
